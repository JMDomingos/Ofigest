...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <?php echo $this->tag->select(array('id_morada', $moradas, 'using' => array('id', 'morada_rua'), 'useEmpty' => true, 'emptyText' => 'À nossa descrição.', 'emptyValue' => '', 'class' => 'form-control', 'id' => 'fieldIdMorada')); ?>
    </div>
</div>
<div class="form-group">
