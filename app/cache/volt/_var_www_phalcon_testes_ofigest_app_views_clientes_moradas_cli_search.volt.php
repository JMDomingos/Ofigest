...
<div align="row center-block">
    ...
    <div class="row">
        ...
        <div class="col-sm-11">
            <nav>
                <ul class="pagination">
                    <li><?php echo $this->tag->linkTo(array('clientes_moradas_cli/search', ' <i class=\'glyphicon glyphicon-fast-backward\'></i> ')); ?></li>
                    <li><?php echo $this->tag->linkTo(array('clientes_moradas_cli/search?page=' . $page->before, ' <i class=\'glyphicon glyphicon-step-backward\'></i> ')); ?></li>
                    <li><?php echo $this->tag->linkTo(array('clientes_moradas_cli/search?page=' . $page->next, ' <i class=\'glyphicon glyphicon-step-forward\'></i> ')); ?></li>
                    <li><?php echo $this->tag->linkTo(array('clientes_moradas_cli/search?page=' . $page->last, ' <i class=\'glyphicon glyphicon-fast-forward\'></i> ')); ?></li>
                </ul>
            </nav>
        </div>
    </div>
