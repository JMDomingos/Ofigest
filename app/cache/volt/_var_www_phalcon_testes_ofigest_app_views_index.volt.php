...
<html>
    <head>
        ...
        <?php echo $this->tag->stylesheetLink('css/vokuro.style.css'); ?>
        <?php echo $this->tag->stylesheetLink('css/datepicker.css'); ?>
        <?php echo $this->tag->stylesheetLink('css/navbar-custom.css'); ?>
    ...
    <body>
        ...
        <?php echo $this->tag->javascriptInclude('js/bootstrap-datepicker.pt.min.js'); ?>
        <script>
