...
<?php echo $this->tag->form(array('manutencoes/save', 'method' => 'post', 'autocomplete' => 'off', 'class' => 'form-horizontal')); ?>
...
<div class="form-group">
    <label for="fieldIdCliente" class="col-sm-2 control-label">Identificação do Cliente</label>
    <div class="col-sm-10">
...
<div class="form-group">
    <label for="fieldIdVeiculo" class="col-sm-2 control-label">Matricula do Veiculo</label>
    <div class="col-sm-10">
