            ...
            <div class="tab-pane" id="B">
                <p>
                    <table class="table table-bordered table-striped" align="center">
                        ...
                        <tbody>
                        <?php $v117864550350859138601iterated = false; ?><?php foreach ($profile->users as $user) { ?><?php $v117864550350859138601iterated = true; ?>
                            <tr>
                        ...
                        <?php } if (!$v117864550350859138601iterated) { ?>
