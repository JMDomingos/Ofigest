<div align="row center-block">
    <div class="row">
        <nav>
            <ul class="pager">
                <li class="previous"><?php echo $this->tag->linkTo(array('veiculos_cli', 'Voltar')); ?></li>
            </ul>
        </nav>
    </div>
    ...
    <?php echo $this->tag->form(array('veiculos_cli/create', 'method' => 'post', 'autocomplete' => 'off', 'class' => 'form-horizontal')); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <?php echo $this->tag->select(array('id_marca', $marcas, 'using' => array('id', 'marca'), 'useEmpty' => true, 'emptyText' => '...', 'emptyValue' => '', 'class' => 'form-control', 'id' => 'fieldIdMarca')); ?>
        </div>
    </div>
    <div class="form-group">
