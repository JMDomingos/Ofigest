...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <?= $this->tag->linkTo(['clientes/edit/' . $id_cliente, ' <i class=\'glyphicon glyphicon-phone\'></i> Ver Detalhes']) ?>
    </div>
</div>
<div class="form-group">
    <label for="fieldMatricula" class="col-sm-2 control-label">Matricula</label>
    <div class="col-sm-10">
        <?= $this->tag->select(['matricula', $veiculos, 'using' => ['matricula', 'oModelo'], 'useEmpty' => true, 'emptyText' => '...', 'emptyValue' => '', 'class' => 'form-control', 'id' => 'fieldMatricula']) ?>
    </div>
</div>
<div class="form-group">
