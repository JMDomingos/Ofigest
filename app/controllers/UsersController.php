...
/*
use Ofigest\Forms\ChangePasswordForm;
use Ofigest\Forms\UsersForm;
use Ofigest\Models\Users;
use Ofigest\Models\PasswordChanges;
*/
...
class UsersController extends ControllerBase
{
    ...
    public function initialize()
    {
        ...
        //$this->view->setTemplateBefore('private');
        $this->tag->setTitle('Utilizadores');
        parent::initialize();
    }
    ...
    public function searchAction()
    {
        ...
        if (count($users) == 0) {
            $this->flash->notice("A pesquisa não devolveu Utilizadores");
