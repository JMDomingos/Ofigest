...
<div class="page-header">
    <h3>
        Criar nova Manutenção a partir desta Marcação
    </h3>
</div>
{{ content() }}
...
<div class="form-group">
    ...
    <div class="col-sm-10" id="datepicker">  {# "value" : "<?php date('Y-m-d'); ?>" #}
...
<div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
        {{ submit_button('Criar nova Manutenção', 'class': 'btn btn-default') }}
    </div>
</div>
</form>
