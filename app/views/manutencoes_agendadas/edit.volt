...
<div class="form-group">
    ...
    <div class="col-sm-2">
        {{ link_to("clientes/edit/"~id_cliente, " <i class='glyphicon glyphicon-phone'></i> Ver Detalhes") }}
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {# TODO: Dá erro qd id=0 .. sem morada
        {{ morada.getMoradaRua() }}<br>
        {{ morada.getMoradaCpLocalidade() }}
        #}
    </div>
</div>
<div class="form-group">
