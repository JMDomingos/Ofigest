<div align="row center-block">
    <div class="page-header">
        ...
        <p>
            {{ link_to("veiculos_cli/new", "Inserir Viatura") }}
        </p>
    </div>
    {{ content() }}
    {{ form("veiculos_cli/search", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            #}
            {{ select("matricula", matriculas, "using": ["matricula", "oModelo"], "useEmpty":true, 'emptyText':'Todas',
            'emptyValue':'', "class" : "form-control", "id" : "fieldMatricula") }}
        </div>
    </div>
    {#
    <div class="form-group">
